					   ...
					   struct snd_ctl_elem_value *ucontrol)
{
	...
	if (!cstream || !audio_effects) {
	/*
	 * If ALSA framework trys to list all controls,
	 * too many errors are printed in some cases.
	 * Without allocating resources this error
	 * is expected Reduce error level to debug.
	 */
